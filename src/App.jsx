    ...
    <div className="page page-transition">
      <div className="page-content" style={{ paddingTop: '156px' }}>
        ...
        <div className="about-text">
          ...
          <p>This site is primarily set in <a href="https://displaay.net/typeface/matter/" target="_blank" rel="noreferrer" style={{ color: 'var(--light)', textDecoration: 'underline', textDecorationColor: 'var(--border-light)', textUnderlineOffset: '2px', transition: 'color 0.15s ease, text-decoration-color 0.15s ease' }} onMouseEnter={e => { e.currentTarget.style.color = 'var(--dark)'; e.currentTarget.style.textDecorationColor = 'var(--dark)' }} onMouseLeave={e => { e.currentTarget.style.color = 'var(--light)'; e.currentTarget.style.textDecorationColor = 'var(--border-light)' }}>Matter by Displaay Type Foundry</a>. I purchased and licensed the Medium and Regular weights. The quotes in the Quotes from animations page use the open source typeface <a href="https://www.fontshare.com/fonts/gambetta" target="_blank" rel="noreferrer" style={{ color: 'var(--light)', textDecoration: 'underline', textDecorationColor: 'var(--border-light)', textUnderlineOffset: '2px', transition: 'color 0.15s ease, text-decoration-color 0.15s ease' }} onMouseEnter={e => { e.currentTarget.style.color = 'var(--dark)'; e.currentTarget.style.textDecorationColor = 'var(--dark)' }} onMouseLeave={e => { e.currentTarget.style.color = 'var(--light)'; e.currentTarget.style.textDecorationColor = 'var(--border-light)' }}>Gambetta by Indian Type Foundry</a> in the Italic style.</p>
          <h2 className="page-heading" style={{ marginTop: '48px' }}>Construction</h2>
          <p>My previous site was built using Framer. This site is built with Claude Code. Things that I can visualize in my head can now be accomplished much quicker and with less friction. Also one less subscription, but I digress. Framer is still a powerful and useful product, but I find more benefit with these new tools.</p>
